...
const openPositions = [
  ...
  },
  {
    ...
    requirements: [
      ...
      "Knowledge of modern ML techniques, particularly in computer vision and generative models",
    ...
    responsibilities: [
      ...
      "Collaborate with product team to integrate ML capabilities",
      "Stay current with the latest research in AI and design"
    ]
  }
];
        ...
        <section className="py-16 bg-primary/10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    ...
                    "Collaboration: We work together across teams and disciplines",
                    "Empathy: We put users at the center of our design process",
              ...
              >
                <img 
                  src="/lovable-uploads/team-image.jpg" 
