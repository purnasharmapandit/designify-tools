...
const BillingSubscriptions = () => {
  ...
  const [post, setPost] = useState<BlogPostType>(blogPosts.billingSubscriptions);

  useEffect(() => {
    const fetchPost = async () => {
      try {
        const fetchedPost = await getPostBySlug('billing-subscriptions');
        if (fetchedPost) {
          setPost(fetchedPost);
        }
      } catch (error) {
        ...
        setPost(blogPosts.billingSubscriptions);
      }
    };
  ...
  const content = (
    <>
      <h2 id="subscription-plans" className="text-2xl font-bold mt-8 mb-4">Understanding Our Subscription Plans</h2>
      <p>
      ...
      <h2 id="managing-subscription" className="text-2xl font-bold mt-8 mb-4">Managing Your Subscription</h2>
      ...
      <h3 id="payment-methods" className="text-xl font-bold mt-6 mb-3">Payment Methods</h3>
      <p>
      ...
      <h3 id="billing-cycle" className="text-xl font-bold mt-6 mb-3">Billing Cycle and Invoices</h3>
      <p>
      ...
      <div id="cancellation-policy" className="bg-blue-50 border-l-4 border-blue-400 p-5 mt-8">
