      ...
      <main>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="p-3 rounded-full bg-gradient-to-r from-brand-purple/30 to-brand-blue/30 mr-4 shadow-md">
                    <Target className="h-6 w-6 text-gray-800 dark:text-brand-purple" />
                  </div>
              ...
              >
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-8 h-full border border-brand-purple/10 shadow-lg">
                  <Palette className="h-8 w-8 text-gray-800 dark:text-brand-purple mb-4 opacity-70" />
                  <blockquote className="italic text-lg text-gray-800 dark:text-gray-200">
                  ...
                  <p className="mt-4 text-right font-semibold text-gray-800 dark:text-brand-purple">— Our Founding Team</p>
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                <div className="p-3 rounded-full bg-gradient-to-r from-brand-pink/30 to-brand-purple/30 mr-4 shadow-md">
                  <Heart className="h-6 w-6 text-gray-800 dark:text-brand-pink" />
                </div>
              ...
              <p className="text-gray-800 dark:text-gray-200 max-w-3xl mx-auto">
              ...
              {[
                {
                  ...
                  icon: <Palette className="h-5 w-5 text-gray-800 dark:text-brand-purple" />
                },
                {
                  title: "Innovation",
                  ...
                  icon: <Rocket className="h-5 w-5 text-gray-800 dark:text-brand-pink" />
                },
                {
                  title: "Quality",
                  ...
                  icon: <Target className="h-5 w-5 text-gray-800 dark:text-brand-blue" />
                },
                {
                  title: "User-Centered",
                  ...
                  borderColor: "border-brand-purple/20",
                  icon: <Users className="h-5 w-5 text-gray-800 dark:text-brand-purple" />
                },
                {
                  title: "Integrity",
                  ...
                  borderColor: "border-brand-pink/20",
                  icon: <Heart className="h-5 w-5 text-gray-800 dark:text-brand-pink" />
                },
                {
                  ...
                  borderColor: "border-brand-blue/20",
                  icon: <Brush className="h-5 w-5 text-gray-800 dark:text-brand-blue" />
                }
              ].map((value, index) => (
                <motion.div 
                  key={index} 
                ...
                >
                  <div className="flex items-center mb-3">
                    {value.icon}
                    <h3 className="text-xl font-semibold ml-2 text-gray-800 dark:text-gray-100">{value.title}</h3>
                  </div>
                  <p className="text-gray-800 dark:text-gray-300">{value.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
            ...
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                <div className="p-3 rounded-full bg-gradient-to-r from-brand-blue/30 to-brand-yellow/30 mr-4 shadow-md">
                  <Users className="h-6 w-6 text-gray-800 dark:text-brand-blue" />
                </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8">
              {[
                ...
                >
                  ...
                  <p className="text-gray-800 dark:text-gray-300 text-sm">{member.bio}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <Rocket className="h-6 w-6 text-gray-800 dark:text-brand-purple" />
            </motion.div>
            <motion.h2 
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
              className="text-gray-800 dark:text-gray-200 max-w-2xl mx-auto mb-8"
            >
